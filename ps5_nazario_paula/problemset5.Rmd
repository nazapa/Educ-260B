...
7. If you try pushing your changes with just `git push`, why will you get an error?
    ...
    __ANSWER__: If you try to push changes with just 'git push', you will get an error because it is an initial push for a new local branch and the --set-upstream command can be used to set up the upstream branch.
...
__ANSWER__: In my output above, the `*` indicates my current branch. I have 2 local branches and I have 1 remote branch.
...
## **RStudio Terminal** 
## git add scripts/ps5_script.R plots/scatterplot_alabama.png
## git commit -m "add u of alabama plot on dev"
...
# git log dev
commit ced36a7d2fdffae02643dea72f2ee7cf41cd56f5 (HEAD -> dev)
Author: Paula Nazario <paulanazario@Paulas-MacBook-Pro.local>
Date:   Fri Feb 11 09:45:36 2022 -0800
...
commit 1c453af24bebf35ee082c487f452a2dd295c8d22 (HEAD -> main, remote_ps5/main)
Author: Paula Nazario <paulanazario@Paulas-MacBook-Pro.local>
Date:   Wed Feb 9 18:15:01 2022 -0800
...
commit ced36a7d2fdffae02643dea72f2ee7cf41cd56f5 (HEAD -> main, dev)
Author: Paula Nazario <paulanazario@Paulas-MacBook-Pro.local>
Date:   Fri Feb 11 09:45:36 2022 -0800

    add u of alabama plot on dev

commit 1c453af24bebf35ee082c487f452a2dd295c8d22 (remote_ps5/main)
Author: Paula Nazario <paulanazario@Paulas-MacBook-Pro.local>
Date:   Wed Feb 9 18:15:01 2022 -0800
...
commit ced36a7d2fdffae02643dea72f2ee7cf41cd56f5 (HEAD -> main, remote_ps5/main, dev)
Author: Paula Nazario <paulanazario@Paulas-MacBook-Pro.local>
Date:   Fri Feb 11 09:45:36 2022 -0800

    add u of alabama plot on dev

commit 1c453af24bebf35ee082c487f452a2dd295c8d22
Author: Paula Nazario <paulanazario@Paulas-MacBook-Pro.local>
Date:   Wed Feb 9 18:15:01 2022 -0800
...
## git commands
git checkout dev
git add scripts/ps5_script.R plots/scatterplot_cuboulder.png
...
git cat-file -p 9793f63

# Commit message of the parent commit
add u of alabama plot on dev

# Why is the parent not just the previous commit listed in the log?
The parent is not just the previous commit listed in the log because the parent commit is "add u of alabama plot on dev", which is different than the previous commits. This merge is 3-way, therefore, the parent commits is the commit before it diverged.
```

...
ggplot(data = housing_df, aes(x = median_income, y = total_rooms)) + geom_smooth() + ggtitle('Correlation Between Median Housing Income and Total Rooms') + xlab('Median Income') + ylab('Total Room') +  theme_classic()
## According to the smoothed prediction lines, it seems like there is a stong correlation between a high median housing income and total rooms.
